...
def CreateBeamModel(variables):
    ...
    Number_of_openings = variables[9]
    ...
    # Loading
    Load = variables[10] #kN

    # Mesh
    Mesh_size = variables[11]
...
"""
    ...
    #Opening Parameters
    Ellipse_raidus_1 = variables[7] #mm
    Ellipse_raidus_2 = variables[8]#mmM
    Number_of_openings = variables[9]
...
models.append([180.0, 100.0, 300.0, 18.0, 20.0, 19.0, 6000.0, 150.0, 100.0, 15, 500.0, 100.0])
models.append([180.0, 100.0, 300.0, 18.0, 20.0, 19.0, 6000.0, 150.0, 100.0, 15, 500.0, 50.0])
models.append([180.0, 100.0, 300.0, 18.0, 20.0, 19.0, 6000.0, 150.0, 100.0, 15, 500.0, 25.0])
models.append([180.0, 100.0, 300.0, 18.0, 20.0, 19.0, 6000.0, 150.0, 100.0, 15, 500.0, 15.0])
models.append([180.0, 100.0, 300.0, 18.0, 20.0, 19.0, 6000.0, 150.0, 100.0, 15, 500.0, 10.0])
